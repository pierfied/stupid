...
public:
    ...
    cosmology(double Omega_m0, double Omega_k0, double Omega_l0, double H0) :
            Omega_m0(Omega_m0), Omega_k0(Omega_k0), Omega_l0(Omega_l0), Omega_0(Omega_m0 + Omega_l0),
            H0(H0), use_real_units(false), u(units()) {}

    cosmology(double Omega_m0, double Omega_k0, double Omega_l0, double H0, units u) :
            Omega_m0(Omega_m0), Omega_k0(Omega_k0), Omega_l0(Omega_l0), Omega_0(Omega_m0 + Omega_l0),
            H0(H0), use_real_units(true), u(u) {}

    double f(double a);

    double unnormalized_D(double a);
